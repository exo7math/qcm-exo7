...
# BUG/TODO : answer['correct'] now appears to be a string 'True' or 'False' when imported from yaml file
# and no more a Boolean True/False
# change has been made for latex-moodle conversion but not for the other cases!
