...
# Other format 'python3 yamltoall.py -f amc toto.yaml' to convert it to 'amc' format
# Other format 'python3 yamltoall.py -f moodle toto.yaml' to convert it to 'moodle' format
...
if output:
    ...
    if output_format == "moodle":
        output_file = (
            file_name + ".moodle"
        )  # Convert to a xml file with a.moodle extension
...
def split_section(title):
    ...
    :param title: Le titre sous la forme 'section | facile | 123.0'
...
def id_generator(size=6, chars=string.ascii_lowercase):
    ...
    :param size: lenght of the id (Default value = 6)
...
def encode_image(filename):
    ...
    :param filename: name of the image without .png
