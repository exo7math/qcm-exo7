...
\qcmlink[cours]{http://exo7.emath.fr/cours/ch_suites.pdf}{Les suites}

\qcmlink[video]{http://youtu.be/eKWRb_wLczo}{Premières définitions}

\qcmlink[video]{http://youtu.be/253AEiNBvGw}{Limite}

\qcmlink[video]{http://youtu.be/tvbsvRGI_38}{Exemples remarquables}

\qcmlink[video]{http://youtu.be/0W5KVpj769E}{Théorèmes de convergence}

\qcmlink[video]{http://youtu.be/hqPxTPEqDXw}{Suites récurrentes}

\qcmlink[exercices]{http://exo7.emath.fr/ficpdf/fic00010.pdf}{Suites}
...
\begin{question}
\qtags{motcle=suite arithmétique/géométrique}
