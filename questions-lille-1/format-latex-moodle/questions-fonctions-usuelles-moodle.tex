...
Soit \(f(x)=  \arcsin (\cos  x)\) et  \( g(x)= \arccos (\sin x) \). Quelles sont les assertions vraies ?
    ...
    \item \(f\) est périodique de période \(\pi\).
    \item* \(g\) est périodique de période \(2\pi\).
    \item* \(f\) est une fonction paire.
    \item \(g\) est une fonction impaire.
\end{multi}
...
Soit \((E)\) l'équation : \(\ln (x^2-1) = \ln (x-1) + \ln 2\). Quelles sont les assertions vraies ?
    ...
    \item \((E)\) est définie sur  \(]-\infty, -1[ \cup  ]1,+\infty[\).
    \item* \((E)\) est définie sur  \(]1,+\infty[\).
...
Soit \((E)\) l'équation : \(e^{2x}+e^x-2=0\). Quelles sont les assertions vraies ?
    ...
    \item* \((E)\) admet une unique solution \(x=0\).
\end{multi}
...
Soit \(f(x)=\sqrt[3]{1-x^3}\). Quelles sont les assertions vraies ?
    ...
    \item* \(f\) est définie sur \(\Rr\).
    \item \(f\) est croissante.
    \item* \(f\) est une bijection de \(\Rr\) dans \(\Rr\).
    \item* L'application réciproque de \(f\) est \(f\).
\end{multi}
...
Soit   \(f(x)= \arctan x + \arctan (\frac{1}{x})\).  Quelles sont les assertions vraies ?
    ...
    \item* Le domaine de définition de \(f\) est \(\Rr^*\).
    \item \(f\) est une fonction constante.
    \item \(\forall x\in \Rr^*, \, f(x)=\frac{\pi}{2}\)
    \item* \(\forall x>0, \, f(x)= \frac{\pi}{2}\)
\end{multi}
...
Soit \( f(x)= \frac{2x+1}{x-1}\). Quelles sont les assertions vraies ?
    ...
    \item* \(y=2\) est une asymptote à la courbe de \(f\) en \(+\infty\).
    \item* La courbe de \(f\) admet une asymptote verticale \((x=1)\).
    \item Le point de coordonnées \((1,1)\) est un centre de symétrie du graphe de \(f\).
    \item* Le point de coordonnées \((1,2)\) est un centre de symétrie du graphe de \(f\).
\end{multi}
...
Soit \(f(x)= (-1)^{E(x)}\), où  \(E(x)\) est la partie entière de \(x\). Quelles sont les assertions vraies ?
    ...
    \item \(f\) est périodique de période \(1\).
    \item* \(f\) est périodique de période \(2\).
    \item \(f\) est une fonction paire.
    \item* \(f\) est bornée.
\end{multi}
...
Soit \(f(x)=\sqrt{\frac{x^3}{x-1}}\).  Quelles sont les assertions vraies ?
    ...
    \item* Le domaine de définition de \(f\) est \(]-\infty, 0]\cup ]1,+\infty[\).
    \item \(y=x-\frac{1}{2}\) est une asymptote à la courbe de \(f\) en \(+\infty\).
    \item* \(y=x+\frac{1}{2}\) est une asymptote à la courbe de \(f\) en \(+\infty\).
    \item* \(y=-x-\frac{1}{2}\) est une asymptote en \(-\infty\).
\end{multi}
...
Soit \(f\) une fonction définie par l'équation \((E)\) : \( \arcsin f(x) + \arcsin x = \frac{\pi}{2}\). on notera \(D_f\) le domaine de définition de \(f\). Quelles sont les assertions vraies ?
    ...
    \item \(D_f= [-1,1]\)
    \item \(\forall x \in [-1,1], \, f(x)= -\sqrt{1-x^2}\)
    \item* \(\forall x \in [0,1], \, f(x)= \sqrt{1-x^2}\)
    \item* \(f\) est une bijection de \([0,1]\) dans \([0,1]\).
\end{multi}
...
Soit \(f(x)= \arcsin (\frac{2x}{1+x^2})\). On notera \(D_f\) le domaine de définition de \(f\). Quelles sont les assertions vraies ?
    ...
    \item \(D_f=[-1,1]\)
    \item* \(D_f=\Rr\)
    \item* Si \(x \in [-1,1] \), \(f(x) = 2 \arctan x\)
    \item* Si \(x \ge 1 \), \(f(x) = -2 \arctan x+\pi\)
\end{multi}
...
Soit \(f(x)= \arccos (\frac{1-x^2}{1+x^2})\). On notera \(D_f\) le domaine de définition de \(f\). Quelles sont les assertions vraies ?
    ...
    \item* \(D_f= \Rr\)
    \item \(D_f=[-1,1]\)
    \item* \( f(x)= 2\arctan x, \, \forall x\ge 0\)
    \item* \(f(x)  = 2\arctan |x|, \, \forall x \in \Rr\)
\end{multi}
...
Soit \(f(x)= \arcsin (\sin x) + \arccos (\cos x)\). On notera \(D_f\) le domaine de définition de \(f\).  Quelles sont les assertions vraies ?
    ...
    \item \(D_f=[-1,1]\)
    \item \(\forall x \in \Rr, \, f(x)=2x\)
    \item* \(\forall x \in [-\frac{\pi}{2}, 0], \,  f(x) = 0\)
    \item* \(\forall x \in [-\pi, -\frac{\pi}{2}], \,  f(x) = -\pi -2x\)
\end{multi}
...
Soit \(f(x)= \exp ( \frac{\ln^2 |x|}{\ln^2 |x|+1})\). On notera \(D_f\) le domaine de définition de \(f\).  Quelles sont les assertions vraies ?
    ...
    \item* \(f\) est paire.
    \item \(f\) est croissante sur \(]0,+\infty[\).
    \item* \(f\) est une bijection de \(]0,1]\) dans \([1,e[\).
\end{multi}
...
Soit \(f(x)= x^x(1-x)^{1-x}\). On notera \(D_f\) le domaine de définition de \(f\).  Quelles sont les assertions vraies ?
    ...
    \item* \(D_f=]0,1[\)
    \item* L'ensemble des valeurs de \(f\) est \([\frac{1}{2},1[\).
    \item \(f\) est croissante \(]0,1[\).
    \item* \(f\) est une bijection de \([\frac{1}{2},1[ \) dans \([\frac{1}{2},1[\).
\end{multi}
...
Soit \(f(x)= (1+\frac{1}{x})^x\). Quelles sont les assertions vraies ?
    ...
    \item \(D_f=]0,+\infty[\)
    \item* \(\forall x >0, 1 < f(x) < e\)
    \item \(\forall x >0, f(x) > e\)
    \item* \(\forall x <-1, f(x) > e\)
\end{multi}
