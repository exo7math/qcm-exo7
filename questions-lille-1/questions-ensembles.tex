...
\begin{answers}  
    \bad{$\mathcal{P}(E_2)=\{\{1\},\{2\}\}$}
    \good{$\mathcal{P}(E_2)=\{\varnothing ,\{1\},\{2\},E_2\}$}
    \bad{$\mathrm{Card}(\mathcal{P}(E_n))=n$}
    \good{$\mathrm{Card}(\mathcal{P}(E_n))=2^n$}
\end{answers}
\begin{explanations}
...
\begin{answers}  
    \bad{$\mathrm{Card}(\mathcal{P}_a(E))=n-1$}
    \bad{$\mathrm{Card}(\mathcal{P}_a(E))=n$}
    \good{$\mathrm{Card}(\mathcal{P}_a(E))=2^{n-1}$}
    \bad{$\mathrm{Card}(\mathcal{P}_a(E))=2^n$}
\end{answers}
\begin{explanations}
...
\begin{answers}  
    \good{$\mathrm{Card}(\mathcal{H}(E))=p2^{n-p}$}
    \bad{$\mathrm{Card}(\mathcal{H}(E))=p$}
    \bad{$\mathrm{Card}(\mathcal{H}(E))=p2^p$}
    \bad{$\mathrm{Card}(\mathcal{H}(E))=p2^n$}
\end{answers}
\begin{explanations}
