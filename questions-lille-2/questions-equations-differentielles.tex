...
\begin{question}
\qtags{motcle=équations homogènes/solution générale}
...
\begin{answers}  
\bad{La solution générale de $(E_1)$ sur $\Rr$ est : $\displaystyle y=k\mathrm{e}^{-2x}$, $k\in \Rr$.}
\good{La solution générale de $(E_1)$ sur $\Rr$ est : $\displaystyle y=k\mathrm{e}^{2x}$, $k\in \Rr$.}
\good{La solution générale de $(E_2)$ sur $\Rr$ est : $\displaystyle y=k\mathrm{e}^{-x^2}$, $k\in \Rr$.}
\bad{La solution générale de $(E_2)$ sur $\Rr$ est : $\displaystyle y=k\mathrm{e}^{x^2}$, $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les affirmations suivantes cocher celles qui sont vraies :
\begin{answers}  
\bad{Si $y$ est une solution de $(E_1)$, alors $\displaystyle z=\frac{y}{1+x^2}$ est une solution de $(E_2)$.}
\good{$(E_1)$ est $(E_2)$ ont les mêmes solutions.}
\good{La solution générale de $(E_1)$ sur $\Rr$ est : $\displaystyle y=k\mathrm{e}^{arctan (x)}$, $k\in \Rr$.}
\bad{La solution générale de $(E_2)$ sur $\Rr$ est : $\displaystyle y=k\arctan (x)$, $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=second membre/condition initiale}
On considère l'équation différentielle $(E)$ : $y'-y=\mathrm{e}^t$. Parmi les affirmations suivantes cocher celles qui sont vraies :
\begin{answers}
\good{La fonction $\displaystyle y_0=t\mathrm{e}^{t}$ est une solution de $(E)$.}
\bad{La fonction $\displaystyle y_1=\mathrm{e}^{-t}$ est une solution de $(E)$.}
\bad{La fonction $\displaystyle y=(1-t)\mathrm{e}^{t}$ est l'unique solution de $(E)$ telle que $y(1)=0$.}
\good{La fonction $\displaystyle y=(1+t)\mathrm{e}^{t}$ est l'unique solution de $(E)$ telle que $y(0)=1$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=solution générale/condition initiale}
...
\begin{answers}  
\bad{La solution générale de l'équation homogène sur $\Rr$ est : $y=k\mathrm{e}^{-x^2}$, $k\in \Rr$.}
\good{La fonction $y=-2$ est une solution particulière de $(E)$.}
\good{La solution générale de $(E)$ sur $\Rr$ est : $y=k\mathrm{e}^{x^2}-2$, $k\in \Rr$.}
\bad{$E$ admet une unique solution sur $\Rr$ vérifiant $y'(0)=0$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=équation homogène/solution particulière/condition initiale}
...
\begin{answers}  
\bad{La solution générale de l'équation homogène est $y=k\mathrm{e}^{x}$, $k\in \Rr$.}
\bad{La fonction $\displaystyle y_0=\mathrm{e}^{x}$ est une solution particulière de $(E)$.}
\good{La solution de $(E)$ vérifiant $y(0)=0$ est $\displaystyle y=\frac{\mathrm{e}^{x}-\mathrm{e}^{-x}}{2}$.}
\good{La solution de $(E)$ vérifiant $y'(0)=0$ est $\displaystyle y=\frac{\mathrm{e}^{x}+\mathrm{e}^{-x}}{2}$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=équation homogène/solution particulière}
...
\begin{answers}  
\good{La fonction $\displaystyle y=x^2$ est une solution de $(E)$ sur $\Rr$.}
\bad{La fonction $\displaystyle y=x^2\left(1-\mathrm{e}^{1/x}\right)$ est une solution de l'équation homogène.}
...
\subsection{Equations du premier ordre | Niveau 3}
...
\begin{answers}  
\bad{$\displaystyle A(x)=\ln (1+\cos ^2x)$ est une primitive sur $\Rr$ de $\displaystyle a(x)=\frac{\sin (2x)}{1+\cos ^2x}$.}
\good{Toute solution de $(E)$ vérifie $y'(0)=0$.}
\bad{$(E)$ n'admet pas de solution vérifiant $y(0)=0$.}
\good{La solution générale de $(E)$ est : $\displaystyle y=k+k\cos ^2x$, $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=solution générale/solution particulière/condition initiale}
...
\begin{answers}  
\bad{La solution générale de l'équation homogène est : $\displaystyle y=k\mathrm{e}^{-\arctan x}$, $k\in \Rr$.}
\good{La solution générale de $(E)$ est : $\displaystyle y=-1+k\mathrm{e}^{\arctan x}$, $k\in \Rr$.}
\good{L'unique solution de $(E)$ vérifiant $y(0)=0$ et $\displaystyle y=-1+\mathrm{e}^{\arctan x}$.}
\bad{$(E)$ n'admet pas de solution vérifiant $y'(0)=0$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\good{La solution générale de l'équation homogène est : $y=k\mathrm{e}^{\arcsin x}$, $k\in \Rr$.}
\bad{La solution générale de $(E)$ est : $y=1+k\mathrm{e}^{\arcsin x}$, $k\in \Rr$.}
\bad{La solution de $(E)$ vérifiant $y(0)=0$ est $y=1-\mathrm{e}^{\arcsin x}$.}
\good{$(E)$ admet une unique solution vérifiant $y'(0)=0$ et c'est $y=-1$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\bad{La solution générale de l'équation homogène est : $\displaystyle y=k\mathrm{e}^{1+x^2}$, $k\in \Rr$.}
\good{La solution générale de $(E)$ est : $\displaystyle y=-1+k\mathrm{e}^{\sqrt{1+x^2}}$, $k\in \Rr$.}
\good{Toute solution $y$ de $(E)$ vérifie $y'(0)=0$.}
\bad{$(E)$ admet une unique solution vérifiant $y'(0)=0$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\good{La solution générale de l'équation homogène est : $\displaystyle y=\frac{k}{1+x^2}$, $k\in \Rr$.}
\good{La solution de $(E)$ vérifiant $y(0)=0$ est $\displaystyle y=\frac{x^2}{1+x^2}$.}
\bad{$(E)$ n'admet pas de solution vérifiant $y'(0)=0$.}
\bad{$(E)$ admet une unique solution vérifiant $y'(0)=0$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\good{La solution générale de l'équation homogène est : $y=k\sqrt{1+x^2}$, $k\in \Rr$.}
\good{La fonction $y=\arctan x.\sqrt{1+x^2}$ est une solution de $E$.}
\bad{$(E)$ possède une seule solution sur $\Rr$.}
\bad{La solution de $(E)$ vérifiant $y(0)=0$ est $y=x\sqrt{1+x^2}$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=solution particulière/condition initiale}
...
\bad{La fonction $\displaystyle y=2\mathrm{e}^{-1/x}$ est une solution de $(E)$ sur $\Rr$.}
...
\bad{La fonction nulle est l'unique solution de $(E)$ sur $\Rr$.}
\end{answers}
\begin{explanations}
...
\subsection{Equations du premier ordre | Niveau 4}

\begin{question}
\qtags{motcle=variation de la constante/prolongement par continuité}
...
\begin{answers}  
\bad{La solution générale de l'équation homogène est : $\displaystyle y(x)=k\ln x$, $k\in \Rr$.}
...
\begin{answers}  
\good{La solution générale de l'équation homogène est $\displaystyle y=\frac{k}{\cos (x)}$, $k\in \Rr$.}
\good{Si $\displaystyle y=\frac{k(x)}{\cos (x)}$ est une solution de $(E)$, alors $k'(x)=\cos (x)$.}
\bad{La solution générale de $(E)$ est $\displaystyle y=\frac{k}{\cos (x)}+\sin x$, $k\in \Rr$.}
\bad{$(E)$ possède une solution qui se prolonge par continuité en $-\pi/2$ et en $\pi /2$.}
\end{answers}
\begin{explanations}
...
\bad{Les solutions de $(E)$ sur $\Rr$ sont les fonctions $y(x)=kx^2-x$, où $k\in \Rr$.}
\bad{$(E)$ possède une seule solution sur $\Rr$.}
\end{answers}
\begin{explanations}
...
\bad{Les solutions de $(E)$ sur $\Rr$ sont les fonctions $\displaystyle y=x+\frac{k}{x+1}$, où $k\in \Rr$.}
\bad{$(E)$ possède une infinité de solutions sur $\Rr$.}
\end{answers}
\begin{explanations}
...
\bad{L'équation $(E)$ admet une solution sur $\Rr$.}
...
\begin{question}
\qtags{motcle=équation homogène}
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{La solution générale de l'équation différentielle $y''-y=0$ sur $\Rr$ est 
$$\displaystyle y=(k_1x+k_2)\mathrm{e}^{x},\quad k_1,k_2\in \Rr.$$}
\good{La solution générale de l'équation différentielle $y''-y=0$ sur $\Rr$ est 
$$\displaystyle y=k_1\mathrm{e}^{x}+k_2\mathrm{e}^{-x},\quad k_1,k_2\in \Rr.$$}
\good{La solution générale de l'équation différentielle $y''-3y'+2y=0$ sur $\Rr$ est
$$\displaystyle y=k_1\mathrm{e}^{x}+k_2\mathrm{e}^{2x},\quad k_1,k_2\in \Rr.$$}
\bad{La solution générale de l'équation différentielle $y''-3y'+2y=0$ sur $\Rr$ est
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\good{Les solutions sur $\Rr$ de l'équation différentielle $y''-2y'+y=0$ sont les fonctions $\displaystyle y=(k_1+k_2x)\mathrm{e}^{x}$, $k_1,k_2\in \Rr$.}
\bad{Les solutions sur $\Rr$ de l'équation différentielle $y''-2y'+y=0$ sont les fonctions $\displaystyle y_1=\mathrm{e}^{x}$ et $\displaystyle y_2=x\mathrm{e}^{x}$.}
\bad{Les solutions sur $\Rr$ de l'équation différentielle $y''+4y'+4y=0$ sont les fonctions $\displaystyle y_1=\mathrm{e}^{2x}$ et $y_2=2\mathrm{e}^{2x}$.}
\good{Les solutions sur $\Rr$ de l'équation différentielle $y''+4y'+4y=0$ sont les fonctions $\displaystyle y=(k_1+k_2x)\mathrm{e}^{-2x}$, $k_1,k_2\in \Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{Les solutions sur $\Rr$ de l'équation différentielle $y''+y=0$ sont les fonctions $\displaystyle y_1=\sin (x)$ et $y_2=\cos (x)$.}
\good{Les solutions sur $\Rr$ de l'équation différentielle $y''+y=0$ sont les fonctions $\displaystyle y=k_1\cos (x)+k_2\sin (x)$, $k_1,k_2\in \Rr$.}
\bad{Les solutions sur $\Rr$ de l'équation différentielle $y''+4y=0$ sont les fonctions $\displaystyle y_1=\sin (2x)$ et $y_2=\cos (2x)$.}
\good{Les solutions sur $\Rr$ de l'équation différentielle $y''+4y=0$ sont les fonctions $\displaystyle y=k_1\cos (2x)+k_2\sin (2x)$, $k_1,k_2\in \Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{Les solutions sur $\Rr$ de l'équation différentielle $y''-2y'+2y=0$ sont les fonctions $\displaystyle y=k_1\cos (x)+k_2\sin (x)$, $k_1,k_2\in \Rr$.}
\good{Les solutions sur $\Rr$ de l'équation différentielle $y''-2y'+2y=0$ sont les fonctions $\displaystyle y=\mathrm{e}^{x}[k_1\cos (x)+k_2\sin (x)]$, $k_1,k_2\in \Rr$.}
\good{Les solutions sur $\Rr$ de l'équation différentielle $y''+2y'+5y=0$ sont les fonctions $\displaystyle y=\mathrm{e}^{-x}[k_1\cos (2x)+k_2\sin (2x)]$, $k_1,k_2\in \Rr$.}
\bad{Les solutions sur $\Rr$ de l'équation différentielle $y''+2y'+5y=0$ sont les fonctions $\displaystyle y_1=\mathrm{e}^{-x}\cos ( 2x)$ et $y_2=\mathrm{e}^{-x}\sin (2x)$.}
\end{answers}
\begin{explanations}
...
\subsection{Equations du second ordre | Niveau 2}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\good{La solution générale de $(E_1)$ est : $\displaystyle y=-x+k_1\mathrm{e}^{2x}+k_2\mathrm{e}^{-2x}$, $k_1,k_2\in \Rr$.}
\bad{Les solutions de $(E_1)$ sont les fonctions $\displaystyle y=-x+\mathrm{e}^{2x}$ et $y_2=-x+\mathrm{e}^{-2x}$.}
\bad{La solution générale de $(E_2)$ est : $\displaystyle y=x+k\mathrm{e}^{-x}$, $k\in \Rr$.}
\good{La solution générale de $(E_2)$ est $\displaystyle y=x+(k_1x+k_2)\mathrm{e}^{-x}$, $k_1,k_2\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=solution générale/solution particulière}
Sur $\Rr$, on considère les équations différentielles :
$$(E_1)\; :\; y''-y'-2y=2\quad \mbox{et}\quad (E_2)\; :\; y''+y=x.$$
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\good{Les solutions de $(E_1)$ sont les fonctions $\displaystyle y=-1+k_1\mathrm{e}^{2x}+k_2\mathrm{e}^{-x}$, $k_1,k_2\in \Rr$.}
\bad{Les solutions de $(E_1)$ sont les fonctions $\displaystyle y_1=-1+\mathrm{e}^{2x}$ et $y_2=-1+\mathrm{e}^{-x}$.}
\good{Les solutions de $(E_2)$ sont les fonctions $\displaystyle y=x+k_1\cos (x)+k_2\sin (x)$, $k_1,k_2\in \Rr$.}
\bad{Les solutions de $(E_2)$ sont les fonctions $\displaystyle y=x+\cos (x)$ et $y_2=x+\sin (x)$.}
\end{answers}
\begin{explanations}
...
\subsection{Equations du second ordre | Niveau 3}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\good{$(E_1)$ admet une solution particulière sous la forme $\displaystyle y_0=a+b\mathrm{e}^{2x}$ avec $a,b\in \Rr$.}
\bad{$(E_2)$ admet une solution particulière sous la forme $\displaystyle y_0=a+b\mathrm{e}^{x}$ avec $a,b\in \Rr$.}
\bad{La solution générale de $(E_1)$ est : $\displaystyle y=-3+\mathrm{e}^{2x}+k_1\mathrm{e}^{x}+k_2\mathrm{e}^{-x}$, $k_1,k_2\in \Rr$.}
\good{La solution générale de $(E_2)$ est : $\displaystyle y=-2+\left(k_1+\frac{x}{2}\right)\mathrm{e}^{x}+k_2\mathrm{e}^{-x}$, $k_1,k_2\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=équation caractéristique/solution générale/solution particulière}
On considère les équations différentielles :
$$(E_1)\; :\; y''-4y'+4y=4+2\mathrm{e}^{2x}\quad \mbox{et}\quad (E_2)\; :\; y''-4y'+4y=8+\mathrm{e}^{x}.$$
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{$(E_1)$ admet une solution particulière sous la forme $\displaystyle y_0=a+b\mathrm{e}^{2x}$ avec $a,b\in \Rr$.}
\good{$(E_2)$ admet une solution particulière sous la forme $\displaystyle y_0=a+b\mathrm{e}^{x}$ avec $a,b\in \Rr$.}
\good{La solution générale de $(E_1)$ est $\displaystyle y=1+\left(k_1+k_2x+x^2\right)\mathrm{e}^{2x}$, $k_1,k_2\in \Rr$.}
\bad{La solution générale de $(E_2)$ est $\displaystyle y=1+\mathrm{e}^{x}+\left(k_1+k_2x\right)\mathrm{e}^{2x}$, $k_1,k_2\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=solution particulière/solution générale}
On considère les équations différentielles :
$$(E_1)\; :\; y''-3y'+2y=\mathrm{e}^{2x}\quad \mbox{et}\quad (E_2)\; :\; y''-3y'+2y=2x\mathrm{e}^{x}.$$
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{$(E_1)$ admet une solution sous la forme $\displaystyle y_0=a\mathrm{e}^{2x}$ où $a\in \Rr$.}
\bad{$(E_2)$ admet une solution sous la forme $\displaystyle y_0=(ax+b)\mathrm{e}^{x}$ où $a,b\in \Rr$.}
\good{La solution générale de $(E_1)$ est $\displaystyle y=a\mathrm{e}^{x}+(b+x)\mathrm{e}^{2x}$, $a,b\in \Rr$.}
\good{La solution générale de $(E_2)$ est $\displaystyle y=\left(a-2x-x^2\right)\mathrm{e}^{x}+b\mathrm{e}^{2x}$, $a,b\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\bad{Toute solution de $(E)$ est combinaison linéaire de $\sin x$ et $\cos x$.}
\good{Toute solution de $(E)$ est combinaison linéaire de $\sin x$, $\cos x$, $x\sin x$ et $x\cos x$.}
\good{$(E)$ admet une solution sous la forme $y=x(a\sin x+b\cos x)$, où $a,b,\in \Rr$.}
\bad{La solution de $(E)$ telle que $y(0)=0$ et $y'(0)=0$ est $\displaystyle y=x\cos x$.}
\end{answers}
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{$(E_1)$ admet une solution sous la forme $\displaystyle y_0=ax\mathrm{e}^{2x}$ avec $a\in \Rr$.}
\bad{$(E_2)$ admet une solution sous la forme $\displaystyle y_0=a\sin x$ avec $a\in \Rr$.}
\good{La solution générale de $(E_1)$ est $\displaystyle y=\mathrm{e}^{2x}\left[1+a\cos x+b\sin x\right]$, $a,b\in \Rr$.}
\good{La solution générale de $(E_2)$ est $\displaystyle y=\left(1+a\mathrm{e}^{2x}\right)\cos x+\left(1+b\mathrm{e}^{2x}\right)\sin x$, $a,b\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{answers}
\good{Les solutions de l'équation caractéristique sont $1\pm \mathrm{i}$.} 
\bad{$(E)$ admet une solution sous la forme $\displaystyle y_0=a\mathrm{e}^{x}\cos x$ avec $a\in \Rr$.}
\good{La fonction $\displaystyle y_0=x\mathrm{e}^{x}\sin x$ est une solution de $(E)$.}
\bad{La solution générale de $(E)$ est : $\displaystyle y=\mathrm{e}^{x}\left(a\cos x+b\sin x\right)+2\mathrm{e}^{x}\cos x$, $a,b\in \Rr$.}
\end{answers}
\begin{explanations}
...
\subsection{Equations du second ordre | Niveau 4}

\begin{question}
\qtags{motcle=changement de l'inconnue}
On considère les équations différentielles 
$$(E_1)\; :\; xy''+2(x+1)y'+(x+2)y=2\mathrm{e}^{-x}\quad\mbox{et}\quad (E_2)\; :\; y''+2y'+y=2\mathrm{e}^{-x}.$$
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\good{Si $y$ est une solution de $(E_1)$, alors $\displaystyle z=xy$ est une solution de $(E_2)$.}
\bad{$(E_2)$ admet une solution particulière sous la forme $\displaystyle y_0=a\mathrm{e}^{-x}$, $a\in \Rr$.}
...
\begin{answers}  
\good{Si $y$ est une solution de $(E_1)$, alors $\displaystyle z=xy$ est une solution de $(E_2)$.}
\bad{$(E_1)$ admet une solution particulière sous la forme $\displaystyle y_0=a\mathrm{e}^{x}$, $a\in \Rr$.}
...
\bad{$(E_1)$ n'admet pas de solution sur $\Rr$.}
\end{answers}
\begin{explanations}
