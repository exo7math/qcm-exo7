...
\qcmtitle{Systèmes d'équations linéaires }
...
\begin{question}
\qtags{motcle=Système linéaire homogène/Méthode du Pivot de Gauss}
...
\begin{answers} 
\good{$(\mathtt{S}) \Leftrightarrow  \left\{\begin{array}{rcc}
x-y+z&=&0\\
5y-2z&=&0\\ 
z&=&0.\\
\end{array}\right.$ }
\bad{$(\mathtt{S})$ admet une infinité de solutions}.
\bad{$(\mathtt{S})$ n'admet pas de solution}.
\good{$(\mathtt{S})$ admet une unique solution}.
\end{answers}
...
y&=&-x\\
z&=&x.\end{array}\right.$ }
\good{L'ensemble des solutions de $(\mathtt{S})$ est une droite}.
\bad{$(\mathtt{S})$ n'admet pas de solution}.
\bad{$(\mathtt{S})$ admet une unique solution}.
\end{answers}
\begin{explanations} 
$$(\mathtt{S}) \Leftrightarrow  \left\{\begin{array}{rcc}
y&=&-x\\
...
\begin{question}
\qtags{motcle=Système linéaire/Méthode du Pivot de Gauss}
On considère le système d'équations, d'inconnue $(x,y,z)\in \Rr^3$ : 
$$(\mathtt{S})  \; \left\{\begin{array}{rcc}
x-y+2z&=&1\\
-2x+2y-4z&=&-2\\
...
Quelles sont les assertions vraies ?
\begin{answers} 
\good{$(\mathtt{S}) \Leftrightarrow  
x-y+2z=1.$ }
\good{L'ensemble des solutions de $(\mathtt{S})$ est un plan}.
\bad{$(\mathtt{S})$ n'admet pas de solution}.
\bad{$(\mathtt{S})$ admet une unique solution}.
\end{answers}
\begin{explanations} 
...
y-2z&=&1\\ 
z&=&0.\end{array}\right.$}
\good{Les équations de $(\mathtt{S})$ sont celles de trois plans}.
\good{$(\mathtt{S})$ admet une unique solution}.
\bad{$(\mathtt{S})$ n'admet pas de solution}.
\end{answers}
\begin{explanations} 
...
Quelles sont les assertions vraies ?
\begin{answers}  
\bad{$(\mathtt{S}) \Leftrightarrow  \left\{\begin{array}{rcc}
x-y+z&=&1\\
y-2z&=&1.\\  
\end{array}\right.$}
\bad{$(\mathtt{S})$ admet une infinité de solutions}.
\bad{$(\mathtt{S})$ admet une unique solution}.
\good{$(\mathtt{S})$ n'admet pas de solution}.
\end{answers}
\begin{explanations} 
$$(\mathtt{S}) \Leftrightarrow  \left\{\begin{array}{rcc}
x-y+z&=&1\\
...
\begin{question}
\qtags{motcle=Système non linéaire}
On considère le système d'équations, d'inconnue $(x,y,z)\in \Rr^3$ :  
$$(\mathtt{S}) \; \left\{\begin{array}{rcc}
x+y+z&=&1\\
xy+z&=&0\\
...
Quelles sont les assertions vraies ?
\begin{answers}  
\bad{$(\mathtt{S})$ est un système d'équations linéaires.}
\good{$(\mathtt{S}) \Leftrightarrow  \left\{\begin{array}{rcc}
z&=&-2x\\
y&=&1+x\\ 
xy+z&=&0.\end{array}\right.$}
\bad{$(\mathtt{S})$ admet une unique solution.}
\good{$(\mathtt{S})$ admet deux solutions distinctes.}
\end{answers}
...
\begin{question}
\qtags{motcle=Système linéaire à paramètres/Méthode du Pivot de Gauss}
...
Quelles sont les assertions vraies ?
\begin{answers}  
\bad{$(\mathtt{S}) \Leftrightarrow  
\left\{\begin{array}{rcc}
x+y&=&a\\
y+z&=&b\\ 
z+t&=&c.\end{array}\right.$}
\good{$(\mathtt{S})$ admet une  solution si et seulement si $a+c=b+d$.}
\bad{$(\mathtt{S})$ admet une  solution si et seulement si $a+b=c+d$.}
\good{Le rang de $(\mathtt{S})$ est $3$.}
\end{answers}
\begin{explanations} 
$$(\mathtt{S}) \Leftrightarrow  
\left\{\begin{array}{rcc}
...
\bad{$(\mathtt{S})$ n'admet pas de solution.}
\bad{$(\mathtt{S})$ admet une solution si et seulement si $a^2\neq bc$.}
\good{$(\mathtt{S})$ admet une infinité de solutions.}
\end{answers}
...
\begin{question}
\qtags{motcle=Système linéaire à un paramètre/Méthode du Pivot de Gauss}
...
y+2z&=&m.\\ 
\end{array}\right.$}
    \bad{Pour tout réel $m$, $(\mathtt{S})$ admet une solution.}
    \good{Si $m=1$, $(\mathtt{S})$ n'admet pas de solution.}
    \good{Si $m=0$, l'ensemble des solutions de $(\mathtt{S})$ est une droite.}
\end{answers}
\begin{explanations} 
$$(\mathtt{S}) \Leftrightarrow  
\left\{\begin{array}{rcc}
...
\bad{Pour tout réel $m$, $(\mathtt{S})$ admet une infinité de solutions.}
\bad{Si $m=-1$, $(\mathtt{S})$ n'admet pas de solution.}
...
\bad{Si $m=1$ et $a=0$,  $(\mathtt{S})$ admet une unique solution.}
...
(1-m)z&=&1-m.\\
\end{array}\right.$}
\good{Si $m =1$,  $(\mathtt{S})$ admet une infinité de solutions.}
\good{Si $m=-2$, $(\mathtt{S})$ n'admet pas de solution.}
\bad{Si $m\neq 1$,  $(\mathtt{S})$ admet une unique solution.}
\end{answers}
\begin{explanations} 
$$(\mathtt{S}) \Leftrightarrow  
...
\end{array}\right.$}
\good{Si $m=1$, $(\mathtt{S})$ admet une infinité de solutions.}
\bad{Si $m =-3$, $(\mathtt{S})$ admet une unique solution.}
\bad{Si $m\neq 1$, $(\mathtt{S})$ admet une unique solution.}
\end{answers}
\begin{explanations} 
$$(\mathtt{S}) \Leftrightarrow  
...
(c-a)y+(c^2-a^2)z&=&0.\\ 
\end{array}\right.$}
\bad{Si $a,b$ et $c$ sont des réels deux à deux distincts,  $(\mathtt{S})$ admet une infinité de solutions.}
...
\end{array}\right. $}
\bad{Si $m =1$,  $(\mathtt{S})$ admet une infinité de solutions.}
\bad{Si $m\neq 1$, $(\mathtt{S})$ admet une unique solution.}
...
0&=&m-a. \\
\end{array}\right.$}
\bad{Si $m=1$ et $a=-1$, $(\mathtt{S})$ admet une unique solution.}
\bad{Si $m =a$, $(\mathtt{S})$ admet une infinité de solutions.}
...
\begin{question}
\qtags{motcle=Système linéaire/Système homogène}
...
\begin{answers}  
\good{$(\mathtt{S}_H)$ admet au moins une solution.}
\bad{$(\mathtt{S})$ admet au moins une solution.}
\bad{Si $X_1$ et $X_2$ sont des solutions de $(\mathtt{S})$, alors $X_1+X_2$ est une solution de $(\mathtt{S})$.}
\good{$(\mathtt{S})$ admet une infinité de solutions si et seulement si les équations de $(\mathtt{S})$ sont celles de trois droites confondues.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\bad{$(\mathtt{S}_H)$ admet une infinité de solutions.}
\bad{$(\mathtt{S})$ admet une unique solution.}
\good{Si $X_1$ et $X_2$ sont des solutions de $(\mathtt{S})$, alors $X_1-X_2$ est une solution de $(\mathtt{S}_H)$.}
\bad{$(\mathtt{S})$ admet une infinité de solutions si et seulement si les équations de $(\mathtt{S})$ sont celles de $3$ plans confondus.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=Système linéaire/ Système échelonné}
...
\begin{answers}  
\bad{$(\mathtt{S})$ admet une infinité de solutions si et seulement si toute équation de $(\mathtt{S}_E)$ dont le premier membre est nul a aussi son second membre nul.}
\good{$(\mathtt{S})$ n'admet pas de solution si et seulement s'il existe une équation de $(\mathtt{S}_E)$ ayant un premier membre nul et un second membre non nul.}
\bad{$(\mathtt{S})$ admet une unique solution si et seulement si le nombre d'équations de $(\mathtt{S}_E)$ dont le premier membre est non nul est égal au nombre d'inconnues.}
\good{Si le nombre d'équations de $(\mathtt{S}_E)$ dont le premier membre est non nul est strictement inférieur au nombre d'inconnues et les équations ayant un premier membre nul admettent aussi le second membre nul, alors $(\mathtt{S})$ admet une infinité de solutions.}
\end{answers}
\begin{explanations} D'après la méthode du pivot de Gauss, $(\mathtt{S})$ admet une solution si et seulement si toute équation de $(\mathtt{S}_E)$ dont le premier membre est nul a aussi son second membre nul.
\end{explanations}
\end{question}


\begin{question}
\qtags{motcle=Système linéaire/Système échelonné/Rang d'un système}
...
\begin{answers}  
\bad{Si $r=1$, alors $(\mathtt{S})$ admet une infinité de solutions.}
\good{Si $r=2$ et les équations ayant un premier membre nul admettent aussi le second membre nul, alors $(\mathtt{S})$ admet une infinité de solutions.}
\good{Si $r=3$ et l'équation ayant un premier membre nul admet aussi le second membre nul, alors $(\mathtt{S})$ admet une unique solution.}
\bad{Si $r=3$, alors $(\mathtt{S})$ admet une unique solution.}
\end{answers}
\begin{explanations} D'après la méthode du pivot de Gauss, $(\mathtt{S})$ admet une solution si et seulement si toute équation de $(\mathtt{S}_E)$ dont le premier membre est nul a aussi son second membre nul.
\end{explanations}
\end{question}
...
\begin{question}
\qtags{motcle=Polynômes/Système linéaire}
...
Quelles sont les assertions vraies ?
\begin{answers}  
\bad{Un tel polynôme $P$ n'existe pas.}
\bad{Il existe une infinité de polynômes $P$ vérifiant ces conditions.}
\good{Il existe un unique polynôme $P$  vérifiant ces conditions.}
\bad{Si $P$ est un polynôme qui vérifie ces conditions, alors $P(2)=2$.}
\end{answers}
...
\begin{question}
\qtags{motcle=Système linéaire à $n$ inconnus et à un paramètre}
...
\good{Si $a=1$, $(\mathtt{S})$ admet une infinité de solutions.}
\bad{Si $a \neq 1$, $(\mathtt{S})$ admet une unique solution.}
\good{$a=1-n$, $(\mathtt{S})$ n'admet pas de solution.}
\end{answers}
\begin{explanations} 
$$(\mathtt{S})  \Leftrightarrow 
\left\{\begin{array}{rcc}
...
\begin{question}
\qtags{motcle=Système linéaire à $n$ inconnus et à paramètres}
...
(b-a)x_n&=&1-a.\\
\end{array}\right.$}
\bad{Si $a=b$, $(\mathtt{S})$ admet une infinité de solutions.}
\bad{Si $a\neq b$, $(\mathtt{S})$ n'admet pas de solution.}
\good{$(\mathtt{S})$ admet une infinité de solutions si et seulement si $a=b=1$.}
\end{answers}
\begin{explanations} L'algorithme de Gauss donne :
$$(\mathtt{S}) \Leftrightarrow  
\left\{\begin{array}{rcc}
...
\begin{question}
\qtags{motcle=Polynôme/Formule de Taylor}
...
\begin{answers}  
\bad{Un tel polynôme $P$ n'existe pas}.
\good{Il existe une infnité de polynômes $P$ vérifiant ces conditions}.
\bad{Il existe un unique polynôme $P$ vérifiant ces conditions}.
\bad{Si $P$ est un polynôme qui vérifie ces conditions, alors
