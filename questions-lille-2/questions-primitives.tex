...
\begin{answers}  
\good{Si $u$ est une fonction dérivable, strictement positive, alors $\sqrt{u}$ est une primitive de $\displaystyle \frac{u'}{2\sqrt{u}}$.}
\good{Si $u$ est une fonction dérivable, alors $\arctan (u)$ est une primitive de $\displaystyle \frac{u'}{1+u^2}$.}
\bad{Si $u$ est une fonction dérivable, alors $\mathrm{e}^u$ est une primitive de $\displaystyle \mathrm{e}^u$.}
\bad{Si $u$ est une fonction dérivable et ne s'annulant pas, alors $\ln (u)$ est une primitive de $\displaystyle \frac{u'}{u}$.}
\end{answers}
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{$\displaystyle F(x)=x^2+\mathrm{e}^{x^2}$ est une primitive de $\displaystyle f(x)=2x+\mathrm{e}^{2x}$ sur $\Rr$.}
\good{$\displaystyle F(x)=x^2+\frac{\mathrm{e}^{2x}}{2}$ est une primitive de $\displaystyle f(x)=2x+\mathrm{e}^{2x}$ sur $\Rr$.}
\bad{$\displaystyle F(x)=x^2\mathrm{e}^{x}$ est une primitive de $\displaystyle f(x)=2x\mathrm{e}^{x}$ sur $\Rr$.}
\good{$\displaystyle F(x)=(2x-2)\mathrm{e}^{x}$ est une primitive de $\displaystyle f(x)=2x\mathrm{e}^{x}$ sur $\Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\good{$\displaystyle F(x)=(x+1)^2+\cos (2x)$ est une primitive de $\displaystyle f(x)=2x+2-2\sin (2x)$ sur $\Rr$.}
\bad{$\displaystyle F(x)=x^2+2x-\cos (2x)$ est une primitive de $\displaystyle f(x)=2x+2-2\sin (2x)$ sur $\Rr$.}
\bad{$\displaystyle F(x)=2x^2\cos (x^2)$ est une primitive de $\displaystyle f(x)=4x\sin (2x)$ sur $\Rr$.}
\good{$\displaystyle F(x)=-2x\cos (2x)+\sin (2x)$ est une primitive de $\displaystyle f(x)=4x\sin (2x)$ sur $\Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{Une primitive de $\displaystyle f(x)=\mathrm{e}^{-x}\cos x$ sur $\Rr$ est $\displaystyle F(x)=\mathrm{e}^{-x}\cos x$.}
\bad{Une primitive de $\displaystyle f(x)=\mathrm{e}^{-x}\cos x$ sur $\Rr$ est $\displaystyle F(x)=\frac{1}{2}\mathrm{e}^{-x}\left(\cos x+\sin x\right)$.}
\good{Une primitive de $\displaystyle f(x)=\mathrm{e}^{-x}\cos x$ sur $\Rr$ est $\displaystyle F(x)=\frac{1}{2}\mathrm{e}^{-x}\left(\sin x-\cos x\right)$.}
\good{Une primitive de $\displaystyle f(x)=\mathrm{e}^{-x}\cos x$ sur $\Rr$ est $\displaystyle F(x)=\frac{1}{\sqrt{2}}\mathrm{e}^{-x}\sin \left(x-\frac{\pi}{4}\right)$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\bad{$\displaystyle \int \left(\frac{2}{x}+\mathrm{e}^{2x}\right)\mathrm{d}x=\frac{-2}{x^2}+2\mathrm{e}^{2x}+k$, où $k\in \Rr$.}
\good{$\displaystyle \int \left(\frac{2}{x}+\mathrm{e}^{2x}\right)\mathrm{d}x=\ln (x^2)+\frac{1}{2}\mathrm{e}^{2x}+k$, où $k\in \Rr$.}
\good{$\displaystyle \int \left(\frac{1}{2\sqrt{x}}-\sin x\right)\mathrm{d}x=\sqrt{x}+\cos x+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int \left(\frac{1}{2\sqrt{x}}-\sin x\right)\mathrm{d}x=\sqrt{x}-\cos x+k$, où $k\in \Rr$.}
\end{answers}
\vskip3mm
\begin{explanations}
...
\begin{answers}  
    \bad{$\displaystyle \int \frac{\mathrm{d}x}{(x+1)^3}=\frac{-3}{(x+1)^4}+k$, où $k\in \Rr$.}
    \good{$\displaystyle \int \frac{\mathrm{d}x}{(x+1)^3}=\frac{-1}{2(x+1)^2}+k$, où $k\in \Rr$.}
    \good{$\displaystyle \int \frac{\mathrm{d}x}{x+1}=\ln (x+1)+k$, où $k\in \Rr$.}
    \bad{$\displaystyle \int \frac{\mathrm{d}x}{x+1}=\frac{-1}{(x+1)^2}+k$, où $k\in \Rr$.}
\end{answers}
\vskip3mm
\begin{explanations}
...
\begin{answers}  
\bad{$\displaystyle F(x)=x\ln x+k$, où $k\in \Rr$.}
\bad{$\displaystyle F(x)=\frac{x^2}{2}\mathrm{e}^x+k$, où $k\in \Rr$.} 
\good{$\displaystyle F(x)=x\mathrm{e}^x-\int \mathrm{e}^x\mathrm{d}x$.}       
\good{$\displaystyle F(x)=(x-1)\mathrm{e}^x+k$, où $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\bad{$\displaystyle F(x)=\mathrm{e}^{x}+k$, $k\in \Rr$.}
\good{$\displaystyle F(x)=x\ln x-\int \mathrm{d}x$.}
\good{$\displaystyle F(x)=x\ln x-x+k$, $k\in \Rr$.}
\bad{$\displaystyle F(x)=\frac{1}{x}+k$, $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=changement de variables}
Parmi les égalités suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{$\displaystyle \int 4x^3(2+x^4)^3\mathrm{d}x=x^4(2+x^4)^3+k$, où $k\in \Rr$.}
\good{$\displaystyle \int 4x^3(2+x^4)^3\mathrm{d}x=\frac{(2+x^4)^4}{4}+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int \frac{6x\mathrm{d}x}{1+3x^2}=6\int x\mathrm{d}x\times\int \frac{\mathrm{d}x}{1+3x^2}=3x^2\times\ln (1+3x^2)+k$, $k\in \Rr$.}
\good{$\displaystyle \int \frac{6x\mathrm{d}x}{1+3x^2}=\ln(1+3x^2)+k$, où $k\in \Rr$.}
\end{answers}
\vskip3mm
\begin{explanations}
...
Parmi les égalités suivantes, cocher celles qui sont vraies :
\begin{answers}  
\good{$\displaystyle \int 4x\sqrt{2x^2+1}\mathrm{d}x=\frac{2}{3}(2x^2+1)^{3/2}+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int \sqrt{2x^2+1}\mathrm{d}x=\frac{2}{3}(2x^2+1)^{3/2}+k$, où $k\in \Rr$.}
\good{$\displaystyle \int \frac{3x\mathrm{d}x}{\sqrt{3x^2+2}}=\sqrt{3x^2+2}+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int \frac{\mathrm{d}x}{2\sqrt{3x^2+2}}=\sqrt{3x^2+2}+k$, où $k\in \Rr$.}
\end{answers}
\vskip3mm
\begin{explanations}
...
\begin{question}
\qtags{motcle=changements de variables/primitives usuelles}
Parmi les assertions suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{Les primitives de $16x^3(x^4+1)^3$ sur $\Rr$ sont données par $\displaystyle F(x)=x^4(x^4+1)^4+k$, $k\in \Rr$.}
\good{Les primitives de $16x^3(x^4+1)^3$ sur $\Rr$ sont données par $\displaystyle F(x)=(x^4+1)^4+k$, $k\in \Rr$.}
\good{Les primitives de $\displaystyle \frac{4x^3}{\sqrt{x^4+1}}$ sur $\Rr$ sont données par $\displaystyle F(x)=2\sqrt{x^4+1}+k$, $k\in \Rr$.}
\bad{Les primitives de $\displaystyle \frac{4x^3}{\sqrt{x^4+1}}$ sur $\Rr$ sont données par $\displaystyle F(x)=\frac{x^4}{\sqrt{x^4+1}}+k$, $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les égalités suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{$\displaystyle \int \left(\mathrm{e}^{3x}+\frac{1}{1+4x^2}\right)\mathrm{d}x=\mathrm{e}^{3x}+\arctan (2x)+k,\; k\in \Rr$.}
\good{$\displaystyle \int \left(\mathrm{e}^{3x}+\frac{1}{1+4x^2}\right)\mathrm{d}x=\frac{\mathrm{e}^{3x}}{3}+\frac{\arctan (2x)}{2}+k,\; k\in \Rr$.}
\good{$\displaystyle \int \left(\mathrm{e}^{3x}+\frac{4}{1+x^2}\right)\mathrm{d}x=\frac{\mathrm{e}^{3x}}{3}+4\arctan x+k,\; k\in \Rr$.}
\bad{$\displaystyle \int \left(\mathrm{e}^{3x}+\frac{4}{1+x^2}\right)\mathrm{d}x=\mathrm{e}^{3x}+4\arctan x+k,\; k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{question}
\qtags{motcle=changement de variable/primitives usuelles}
Parmi les égalités suivantes, cocher celles qui sont vraies :
\begin{answers}  
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{$\displaystyle \int x\sqrt{x^2+1}\, \mathrm{d}x=\frac{x^2}{2}(1+x^2)^{3/2}+k$, $k\in \Rr$.}
\good{$\displaystyle \int x\sqrt{x^2+1}\, \mathrm{d}x=\frac{1}{3}(1+x^2)^{3/2}+k$, $k\in \Rr$.}
\bad{$\displaystyle \int \frac{x\, \mathrm{d}x}{\sqrt{x^2+1}}=\frac{x^2}{2}\frac{1}{\sqrt{x^2+1}}+k$, $k\in \Rr$.}
\good{$\displaystyle \int \frac{x\, \mathrm{d}x}{\sqrt{x^2+1}}=\sqrt{x^2+1}+k$, $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{$\displaystyle \int \frac{x\mathrm{d}x}{1+x^2}=\arctan (x)+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int x\mathrm{e}^{(1+x^2)}\mathrm{d}x=\frac{x^2}{2}\mathrm{e}^{(1+x^2)}+k$, où $k\in \Rr$.}
\good{$\displaystyle \int \frac{x\mathrm{d}x}{1+x^2}=\ln\sqrt{1+x^2}+k$, où $k\in \Rr$.}
\good{$\displaystyle \int x\mathrm{e}^{(1+x^2)}\mathrm{d}x=\frac{1}{2}\mathrm{e}^{(1+x^2)}+k$, où $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{Le changement de variable $\displaystyle u=x(1+x^4)$ donne $\displaystyle \int 4x^3(1+x^4)^3\mathrm{d}x=\int 4u^3\mathrm{d}u$.}
\good{Le changement de variable $\displaystyle u=1+x^4$ donne $\displaystyle \int 4x^3(1+x^4)^3\mathrm{d}x=\int u^3\mathrm{d}u$.}
\bad{Le changement de variable $\displaystyle u=2x$ donne $\displaystyle \int \frac{\mathrm{d}x}{1+4x^2}=\int \frac{\mathrm{d}u}{1+u^2}$.}
\good{Le changement de variable $\displaystyle u=2x$ donne $\displaystyle \int \frac{\mathrm{d}x}{1+4x^2}=\frac{1}{2}\int \frac{\mathrm{d}u}{1+u^2}$.}
\end{answers}
\vskip2mm
\begin{explanations}
...
\begin{answers}  
\bad{$\displaystyle F(x)=\frac{x^2}{2}\ln x+k$, où $k\in \Rr$.}    
\good{$\displaystyle F(x)=\frac{x^2}{2}\ln x-\frac{1}{2}\int x\mathrm{d}x$.}    
\bad{$\displaystyle F(x)=\frac{x^2}{2}\ln x-\frac{x}{2}+k$, où $k\in \Rr$.}
\good{$\displaystyle F(x)=\frac{x^2}{2}\ln x-\frac{x^2}{4}+k$, où $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les égalités suivantes, cocher celles qui sont vraies :
\begin{answers}  
\good{$\displaystyle \int x\cos(1+x^2)\mathrm{d}x=\frac{1}{2}\sin(1+x^2)+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int \mathrm{e}^x\sin\left(2+\mathrm{e}^x\right)\mathrm{d}x=\int \mathrm{e}^x\mathrm{d}x\times \int\sin\left(2+\mathrm{e}^x\right)\mathrm{d}x$.}
\bad{$\displaystyle \int x\cos(1+x^2)\mathrm{d}x=\frac{x^2}{2}\sin(1+x^2)+k$, où $k\in \Rr$.}
\good{$\displaystyle \int \mathrm{e}^x\sin\left(2+\mathrm{e}^x\right)\mathrm{d}x=-\cos\left(2+\mathrm{e}^x\right)+k$, où $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\bad{$\displaystyle \int \frac{\sin (\sqrt{x})}{\sqrt{x}}\mathrm{d}x=\int \frac{\sin (u)}{u}\mathrm{d}u$.}
\bad{$\displaystyle \int \frac{\sin (\sqrt{x})}{\sqrt{x}}\mathrm{d}x=\cos (u)+k$, $k\in \Rr$.}
\good{$\displaystyle \int \frac{\sin (\sqrt{x})}{\sqrt{x}}\mathrm{d}x=2\int \sin (u)\mathrm{d}u$.}    
\good{$\displaystyle \int \frac{\sin (\sqrt{x})}{\sqrt{x}}\mathrm{d}x=-2\cos (u)+k$, $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\good{$\displaystyle \int \frac{\sin (1/x)}{x^2}\mathrm{d}x=-\int \sin (u)\mathrm{d}u$.}
\good{$\displaystyle \int \frac{\sin (1/x)}{x^2}\mathrm{d}x=\cos\left(1/x\right)+k$, $k\in \Rr$.}
\bad{$\displaystyle \int \sin (1/x)\mathrm{d}x=\int \sin (u)\mathrm{d}u$.}    
\bad{$\displaystyle \int \sin (1/x)\mathrm{d}x=-\cos (u)+k$, $k\in \Rr$.}
\end{answers}
\vskip2mm
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}  
\good{$\displaystyle \int \cos x\sin x\mathrm{d}x=\frac{1}{2}\sin ^2x+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int \cos x\sin x\mathrm{d}x=\frac{1}{2}\cos ^2x+k$, où $k\in \Rr$.}
\good{$\displaystyle \int \cos x\sin ^2x\mathrm{d}x=\frac{1}{3}\sin ^3x+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int \cos ^2x\sin ^2x\mathrm{d}x=\frac{1}{4}\sin ^4x+k$, où $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les assertions suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{Le changement de variable $u=\cos x$ donne $\displaystyle \int \cos ^3x\mathrm{d}x=\int u^3\mathrm{d}u$.}
\good{Le changement de variable $u=\sin x$ donne $\displaystyle \int \cos ^3x\mathrm{d}x=\int (1-u^2)\mathrm{d}u$.}
\bad{Le changement de variable $u=\sin x$ donne $\displaystyle \int \sin ^3x\mathrm{d}x=\int u^3\mathrm{d}u$.}
\good{Le changement de variable $u=\cos x$ donne $\displaystyle \int \sin ^3x\mathrm{d}x=\int (u^2-1)\mathrm{d}u$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\good{$\displaystyle \int \sin x(2+\cos x)^5\mathrm{d}x=-\frac{(2+\cos x)^6}{6}+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int (2+\cos x)^5\mathrm{d}x=\frac{((2+\cos x)^5)^6}{6}+k$, où $k\in \Rr$.}
\good{$\displaystyle \int \sin x\left(2+\cos x\right)^{-3}\mathrm{d}x=\frac{\left(2+\cos x\right)^{-2}}{2}+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int \left(2+\cos x\right)^{-3}\mathrm{d}x=\frac{\left(2+\cos x\right)^{-2}}{2}+k$, où $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\good{$\displaystyle \int \cos x\mathrm{e}^{2+\sin x}\mathrm{d}x=\mathrm{e}^{2+\sin x}+k$, où $k\in \Rr$.}
\bad{$\displaystyle \int \mathrm{e}^{2+\sin x}\mathrm{d}x=\int \mathrm{e}^u\mathrm{d}u$.}
\bad{$\displaystyle \int \frac{\mathrm{d}x}{2+\sin x}=\int \frac{\mathrm{d}u}u$.}
\good{$\displaystyle \int \frac{\cos x\mathrm{d}x}{2+\sin x}=\ln(2+\sin x)+k$, où $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\good{$\displaystyle \int \frac{\cos x}{1+\sin ^2x}\mathrm{d}x=\int \frac{\mathrm{d}u}{1+u^2}$.}
\good{$\displaystyle \int \frac{\cos x}{1+\sin ^2x}\mathrm{d}x=\arctan (u)+k$, $k\in \Rr$.}
\bad{$\displaystyle \int \frac{\mathrm{d}x}{1+\sin ^2x}=\int \frac{\mathrm{d}u}{1+u^2}$.}
\bad{$\displaystyle \int \frac{\mathrm{d}x}{1+\sin ^2x}=\arctan (u)+k$, $k\in \Rr$.}    
\end{answers}
\begin{explanations}
...
Parmi les égalités suivantes, cocher celles qui sont vraies :
\begin{answers}  
\bad{$\displaystyle \int \cos (2x)\sqrt{1+\sin (2x)}\mathrm{d}x=\frac{\cos (2x)}{\sqrt{1+\sin (2x)}}+k$, où $k\in \Rr$.}
\good{$\displaystyle \int \cos (2x)\sqrt{1+\sin (2x)}\mathrm{d}x=\frac{1}{3}\left[1+\sin (2x)\right]^{3/2}+k$, où $k\in \Rr$.}
\good{$\displaystyle \int \frac{\sin (3x)\mathrm{d}x}{2-\cos (3x)}=\frac{1}{3}\ln \left[2-\cos (3x)\right]+k$ où $k\in \Rr$.}
\bad{$\displaystyle \int \frac{\mathrm{d}x}{2-\cos (3x)}=\ln \left[2-\cos (3x)\right]+k$, $k\in \Rr$.}    
\end{answers}
\begin{explanations}
...
\begin{answers}  
\good{$\displaystyle \int \frac{\mathrm{e}^x\mathrm{d}x}{1+\mathrm{e}^{2x}}=\int \frac{\mathrm{d}u}{1+u^2}$.}
\good{$\displaystyle \int \frac{\mathrm{e}^x\mathrm{d}x}{1+\mathrm{e}^{2x}}=\arctan(u)+k$, $k\in \Rr$.}   
\bad{$\displaystyle \int \frac{\mathrm{d}x}{1+\mathrm{e}^{2x}}=\int \frac{\mathrm{d}u}{1+u^2}$.} 
\bad{$\displaystyle \int \frac{\mathrm{d}x}{1+\mathrm{e}^{2x}}=\arctan(u)+k$, $k\in \Rr$.}
\end{answers}
\vskip2mm
\begin{explanations}
...
\begin{answers}  
\bad{$\displaystyle \int \frac{\mathrm{d}x}{\sqrt{\mathrm{e}^{2x}-1}}=\int \frac{\mathrm{d}u}{\sqrt{1-u^2}}$.}
\good{$\displaystyle \int \frac{\mathrm{d}x}{\sqrt{\mathrm{e}^{2x}-1}}=-\arcsin (u)+k$, $k\in \Rr$.}
\bad{$\displaystyle \int \frac{\mathrm{e}^{-x}\mathrm{d}x}{\sqrt{\mathrm{e}^{2x}-1}}=\int \frac{u\mathrm{d}u}{\sqrt{1-u^2}}$.}
\good{$\displaystyle \int \frac{\mathrm{e}^{-x}\mathrm{d}x}{\sqrt{\mathrm{e}^{2x}-1}}=\sqrt{(1-u^2)}+k$, $k\in \Rr$.}
\end{answers}
\vskip2mm
\begin{explanations}
Avec $u=\mathrm{e}^{-x}$, on aura : $\mathrm{d}u=-\mathrm{e}^{-x}\mathrm{d}x$. D'où
...
\begin{answers}  
\bad{$\displaystyle F(x)=\frac{1}{\sqrt{1-x^2}}+k$, où $k\in \Rr$.}
\good{$\displaystyle F(x)=x\arcsin (x)-\int \frac{x\mathrm{d}x}{\sqrt{1-x^2}}$.}
\bad{$\displaystyle F(x)=\arccos (x)+k$, où $k\in \Rr$.}
\good{$\displaystyle F(x)=x\arcsin (x)+\sqrt{1-x^2}+k$, où $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\bad{$\displaystyle F(x)=\frac{1}{1+x^2}+k$, où $k\in \Rr$.}
\bad{$\displaystyle F(x)=x\arctan (x)+k$, où $k\in \Rr$.}
\good{$\displaystyle F(x)=x\arctan (x)-\int \frac{x\mathrm{d}x}{1+x^2}$.}
\good{$\displaystyle F(x)=x\arctan (x)-\frac{1}{2}\ln (1+x^2)+k$, où $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\bad{$\displaystyle \int \ln (x+1)\, \mathrm{d}x=\mathrm{e}^{x+1}+k$, où $k\in \Rr$.}
\good{$\displaystyle \int \ln (x+1)\, \mathrm{d}x=(x+1)\ln (x+1)-\int \mathrm{d}x$.}
\bad{$\displaystyle \int x\ln (1+x)\mathrm{d}x=\int x\mathrm{d}x\times\ln (1+x)=\frac{x^2}{2}\ln (1+x)+k$, où $k\in \Rr$.}
\good{$\displaystyle \int x\ln (1+x)\mathrm{d}x=\frac{x^2}{2}\ln (1+x)-\int \frac{x^2\mathrm{d}x}{2(1+x)}$.}
\end{answers}
\begin{explanations}
...
\begin{answers} 
\good{$f$ admet une primitive sur $\Rr$.} 
\bad{La fonction $F$ telle que $\displaystyle F(x)=\ln \left(\mathrm{e}^x+\mathrm{e}^{-x}\right)$ est une primitive de $f$ sur $\Rr$.}
\good{La fonction $F$ telle que $\displaystyle F(x)=\frac{\pi}{4}-\arctan \left(\mathrm{e}^{-x}\right)$ est une primitive de $f$ sur $\Rr$.}
\bad{La primitive de $f$ sur $\Rr$ qui s'annule en $0$ est d\'efinie par $\displaystyle F(x)=\frac{\pi}{4}-\arctan \left(\mathrm{e}^{x}\right)$.}
\end{answers}
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers} 
\bad{$\displaystyle \int \frac{\mathrm{d}x}{\sqrt{1-x^2}}=-\arcsin (x)+k$, $k\in \Rr$.} 
\good{$\displaystyle \int \sqrt{1-x^2}\mathrm{d}x=x\sqrt{1-x^2}+\int \frac{x^2\mathrm{d}x}{\sqrt{1-x^2}}$.}
\bad{L'égalité $x^2=(x^2-1)+1$ donne : $\displaystyle \int \frac{x^2\mathrm{d}x}{\sqrt{1-x^2}}=-\arcsin x-\int \sqrt{1-x^2}\mathrm{d}
x$.}
...
\begin{answers}  
\bad{$\sin x=\sqrt{1-\cos ^2x}$ et $\displaystyle \int \frac{\mathrm{d}x}{\sin x}=\int \frac{\mathrm{d}t}{\sqrt{1-t^2}}=\arcsin t+k$, $k\in \Rr$.}
\good{$\displaystyle \int \frac{\mathrm{d}x}{\sin x}=\int \frac{\mathrm{d}t}{t^2-1}$.}
\good{$\forall t\in \Rr\setminus \{-1,1\}$, $\displaystyle \frac{2}{t^2-1}=\frac{1}{t-1}-\frac{1}{t+1}$.}
\bad{$\displaystyle \int \frac{\mathrm{d}x}{\sin x}=\ln \left(\frac{1-\cos x}{1+\cos x}\right)+k$, $k\in \Rr$.}
\end{answers}
\vskip2mm
\begin{explanations}
...
\begin{answers} 
\good{$\displaystyle f(x)=\frac{1}{1+(2x-1)^2}$.} 
\bad{$\displaystyle F(x)=\int \frac{\mathrm{d}u}{1+u^2}$ avec $u=2x-1$.}
\bad{$\displaystyle F(x)=\arctan (2x-1)+k$, $k\in \Rr$.}
\good{$\displaystyle F(x)=\frac{1}{2}\arctan (2x-1)+k$,\; $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
\begin{answers}
\good{$\forall x\in \Rr$, $\displaystyle f(x)=\frac{2x+2}{x^2+2x+2}+\frac{1}{x^2+2x+2}$.}
\bad{$\displaystyle F(x)=\ln (x^2+2x+2)+\frac{1}{x^2+2x+2}+k$, $k\in \Rr$.} 
\bad{$\displaystyle F(x)=\ln (x^2+2x+2)+\arctan(x^2+2x+2)+k$, $k\in \Rr$.}
\good{$\displaystyle F(x)=\ln (x^2+2x+2)+\arctan (x+1)+k$, $k\in \Rr$.}
\end{answers}
\begin{explanations}
...
Parmi les assertions suivantes, cocher celles qui sont vraies :
\begin{answers} 
\bad{Le changement de variable $x=\sin t$ pour $t\in [-\pi/2,\pi/2]$ donne : 
$$\int \sqrt{1-x^2}\mathrm{d}x=\int \sqrt{1-\sin ^2t}\, \mathrm{d}t=\int \cos t\, \mathrm{d}t.$$} 
\good{Le changement de variable $x=\sin t$ pour $t\in [-\pi/2,\pi/2]$ donne : 
$$\int \sqrt{1-x^2}\, \mathrm{d}x=\int \cos ^2t\, \mathrm{d}t.$$}
\bad{$\displaystyle \int \cos ^2t\, \mathrm{d}t=\frac{t}{2}-\frac{\sin (2t)}{4}+k=\frac{t}{2}-\frac{\sin t\cos t}{2}+k$, $k\in\Rr$.}
\good{Une primitive de $\displaystyle \sqrt{1-x^2}$ sur $[-1,1]$ est $\displaystyle \frac{\arcsin x}{2}+\frac{x\sqrt{1-x^2}}{2}$.}
\end{answers}
\begin{explanations}
...
\begin{answers}  
\bad{$\displaystyle \int \frac{x\mathrm{d}x}{x^4-x^2-2}=\int \frac{\sqrt{t}\mathrm{d}t}{t^2-t-2}$.}
\good{$\displaystyle \int \frac{x\mathrm{d}x}{x^4-x^2-2}=\frac{1}{2}\int \frac{\mathrm{d}t}{t^2-t-2}$.}
\good{$\forall t\in \Rr\setminus \{-1,2\}$, $\displaystyle \frac{3}{t^2-t-2}=\frac{1}{t-2}-\frac{1}{t+1}$ et $\displaystyle \int \frac{3\, \mathrm{d}t}{t^2-t-2}=\ln\left|\frac{t-2}{t+1}\right|+k$, $k\in \Rr$.}
\bad{$\displaystyle \int \frac{x\mathrm{d}x}{x^4-x^2-2}=\frac{1}{2}\ln\left|\frac{x^2-2}{x^2+1}\right|+k$, $k\in \Rr$.}
\end{answers}
\vskip2mm
\begin{explanations}
...
\begin{question}
\qtags{motcle=primitives usuelles/fractions rationnelles}
Le changement de variable $t=x^2$, pour $x\in ]0,+\infty[$, donne :
\begin{answers}  
\bad{$\displaystyle \int \frac{2\mathrm{d}x}{x(x^2+1)^2}=\int \frac{\mathrm{d}t}{(t+1)^2}$.}
\good{$\displaystyle \int \frac{2\mathrm{d}x}{x(x^2+1)^2}=\int \frac{\mathrm{d}t}{t(t+1)^2}$.}
\bad{$\displaystyle \int \frac{2\mathrm{d}x}{x(x^2+1)^2}=\int \frac{\mathrm{d}t}{\sqrt{t}(t+1)^2}$.}
\good{$\displaystyle \int \frac{2\mathrm{d}x}{x(x^2+1)^2}=\int \frac{\mathrm{d}t}{t}-\int \frac{\mathrm{d}t}{t+1}-\int \frac{\mathrm{d}t}{(t+1)^2}$.}
\end{answers}
\vskip2mm
\begin{explanations}
Avec $t= x^2$, on a : $\mathrm{d}t=2x\mathrm{d}x$ et 
...
\begin{answers}  
\bad{$\displaystyle \frac{1}{1+\sin ^2x}=\frac{1+t^2}{1+2t^2}$ et $\displaystyle \int \frac{\mathrm{d}x}{1+\sin ^2x}=\int \frac{1+t^2}{1+2t^2}\mathrm{d}t$.}
\bad{$\displaystyle \int \frac{\mathrm{d}x}{1+\sin ^2x}=\frac{t}{2}-\frac{1}{2\sqrt{2}}\arctan(\sqrt{2}t)+k$, $k\in \Rr$.}   
\good{$\displaystyle \int \frac{\mathrm{d}x}{1+\sin ^2x}=\int \frac{1}{1+2t^2}\mathrm{d}t$.} 
...
\begin{answers}  
\bad{$\displaystyle \int \frac{\tan x\mathrm{d}x}{1+\cos ^2x}=\tan x\int \frac{\mathrm{d}t}{1+t^2}=\tan x.\arctan (\cos x)+k$, $k\in \Rr$.}
\good{$\displaystyle \int \frac{\tan x\mathrm{d}x}{1+\cos ^2x}=-\int \frac{\mathrm{d}t}{t(1+t^2)}$.} 
\bad{$\forall t\in \Rr^*$, $\displaystyle \frac{1}{t(1+t^2)}=\frac{t}{1+t^2}-\frac{1}{t}$ et donc $\displaystyle \int \frac{\mathrm{d}t}{t(1+t^2)}=\ln \left(\frac{\sqrt{1+t^2}}{t}\right)+k$, $k\in \Rr$.}   
...
\begin{answers}  
\bad{$\displaystyle \int \frac{\cos ^3x\mathrm{d}x}{1+\sin ^2x}=\cos ^3 x\int \frac{\mathrm{d}t}{1+t^2}$.}
\bad{$\displaystyle \int \frac{\cos ^3x\mathrm{d}x}{1+\sin ^2x}=\cos ^3 x.\arctan (\sin x)+k$, $k\in \Rr$.}  
\good{$\displaystyle \int \frac{\cos ^3x\mathrm{d}x}{1+\sin ^2x}=\int \frac{1-t^2}{1+t^2}\mathrm{d}t$.}  
\good{$\displaystyle \int \frac{\cos ^3x\mathrm{d}x}{1+\sin ^2x}=-t+2\arctan t+k$, $k\in \Rr$.}
\end{answers}
\vskip2mm
\begin{explanations}
...
\begin{answers}
\good{$\displaystyle \int \frac{\mathrm{d}x}{2+\cos x}=\int \frac{2\mathrm{d}t}{3+t^2}$.}
\good{$\displaystyle \int \frac{\mathrm{d}x}{2+\sin x}=\int \frac{\mathrm{d}t}{t^2+t+1}$.}
\bad{$\displaystyle \int \frac{\mathrm{d}x}{2+\cos x}=\frac{1}{\sqrt{3}}\arctan\left(\frac{t}{\sqrt{3}}\right)+k$, $k\in \Rr$.}
\bad{$\displaystyle \int \frac{\mathrm{d}x}{2+\sin x}=\frac{1}{\sqrt{2t+1}}\ln (t^2+t+1)+k$, $k\in \Rr$.}
\end{answers}
\vskip2mm
\begin{explanations}
...
Parmi les affirmations suivantes, cocher celles qui sont vraies :
\begin{answers}
\bad{Le changement de variable $\displaystyle t=\sqrt{x}$ donne $\displaystyle \int \frac{\mathrm{d}x}{\sqrt{x}(x+1)^2}=\int \frac{\mathrm{d}t}{(t^2+1)^2}$.}
\good{$\displaystyle \int \frac{\mathrm{d}t}{t^2+1}=\frac{t}{t^2+1}+\int \frac{2t^2\, \mathrm{d}t}{(t^2+1)^2}$.}
\good{$\displaystyle \int \frac{2\, \mathrm{d}t}{(t^2+1)^2}=\frac{t}{t^2+1}+\arctan t+k$, $k\in \Rr$.}
...
\begin{answers}
\bad{Le changement de variable $\displaystyle t=\sqrt{x}$ donne $\displaystyle \int \frac{\mathrm{d}x}{\sqrt{x}(x-1)^2}=\int \frac{\mathrm{d}t}{(t^2-1)^2}$.}
\good{$\forall t\in \Rr\setminus \{-1,1\}$, $\displaystyle \frac{4}{(t^2-1)^2}=\frac{1}{t+1}-\frac{1}{t-1}+\frac{1}{(t+1)^2}+\frac{1}{(t-1)^2}$.}
\good{$\displaystyle \int \frac{4\mathrm{d}t}{(t^2-1)^2}=\ln \left|\frac{t+1}{t-1}\right|-\frac{2t}{t^2-1}+k$, $k\in \Rr$.}
...
\begin{answers}
\bad{Si $a$ et $b$ sont strictement positifs, il existe une constante $C$ telle que $F(x)=C\arcsin \left(x\sqrt{a/b}\right)$ soit une primitive de $f(x)$.}
\good{Si $a$ et $b$ sont strictement positifs, il existe une constante $C$ telle que $F(x)=C\sqrt{ax^2+b}$ soit une primitive de $xf(x)$.}
\good{Si $a$ est strictement négatif et $b$ est strictement positif, il existe une constante $C$ telle que $F(x)=C\arcsin \left(x\sqrt{-a/b}\right)$ soit une primitive de $f(x)$.}
\bad{Si $a$ est strictement positif et $b$ est strictement négatif, il existe une constante $C$ telle que $F(x)=C\arcsin \left[x\sqrt{a/(-b)}\right]$ soit une primitive de $f(x)$.}
\end{answers}
\vskip2mm
\begin{explanations}
